/*   $Source: bitbucket.org:berkeleylab/gasnet.git/dcmf-conduit/gasnet_coll_barrier_dcmf.h $
...
/* Barrier state */
typedef enum {
  GASNETE_COLL_BARRIER_IDLE = 0,
  GASNETE_COLL_BARRIER_BUSY,
  GASNETE_COLL_BARRIER_DONE
} gasnete_dcmf_barrier_state_t;
