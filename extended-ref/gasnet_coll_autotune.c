...
gasnete_coll_autotune_info_t* gasnete_coll_autotune_init(gasnet_node_t mynode, gasnet_node_t total_nodes, gasnet_image_t my_images, gasnet_image_t total_images, size_t min_scratch_size) {
  ...
  dissem_limit = gasneti_getenv_int_withdefault("GASNET_COLL_GATHER_ALL_DISSEM_LIMIT", MIN(GASNETE_COLL_DEFAULT_DISSEM_LIMIT, gasnet_AMMaxLongRequest()), 1);
  ...
  dissem_limit = gasneti_getenv_int_withdefault("GASNET_COLL_EXCHANGE_DISSEM_LIMIT", MIN(GASNETE_COLL_DEFAULT_DISSEM_LIMIT, gasnet_AMMaxLongRequest()), 1);
